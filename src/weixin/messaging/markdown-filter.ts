 ...
 *
 * Vendored verbatim from @tencent-weixin/openclaw-weixin
 * (src/messaging/markdown-filter.ts). This is the gold-standard filter for the
 * WeChat iLink rich-text renderer.
 *
...
/**
 * Filter a complete (non-streaming) markdown string for WeChat delivery.
 * Equivalent to `f.feed(text) + f.flush()`, matching how the official
 * openclaw-weixin channel applies the filter to outbound text.
 */
